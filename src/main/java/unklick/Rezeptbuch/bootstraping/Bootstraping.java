package unklick.Rezeptbuch.bootstraping;


import org.springframework.context.ApplicationListener;
import org.springframework.context.event.ContextRefreshedEvent;
import org.springframework.stereotype.Component;
import unklick.Rezeptbuch.domain.*;
import unklick.Rezeptbuch.repositories.CategoryRepository;
import unklick.Rezeptbuch.repositories.RecipeRepository;
import unklick.Rezeptbuch.repositories.UnitOfMeasureRepository;
...
@Component
public class Bootstraping implements ApplicationListener<ContextRefreshedEvent> {
    private  final CategoryRepository categoryRepository;
    private final RecipeRepository recipeRepository;
    private final UnitOfMeasureRepository unitOfMeasureRepository;

    public Bootstraping(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository){
